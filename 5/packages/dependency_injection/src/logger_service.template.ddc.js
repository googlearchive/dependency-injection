define(['dart_sdk', 'packages/angular/src/di/reflector', 'packages/dependency_injection/src/logger_service', 'packages/angular/angular.template'], function(dart_sdk, reflector, logger_service, angular) {
  'use strict';
  ...
  dart.trackLibraries("packages/dependency_injection/src/logger_service.template.ddc", {
    "package:dependency_injection/src/logger_service.template.dart": src__logger_service$46template
  }, '{"version":3,"sourceRoot":"","sources":["logger_service.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;MAWI,uCAAQ;YAAG;;;;;AAEb,kBAAI,uCAAQ,GAAE;AACZ;;AAEF,8CAAW;AAEX,IAAO,kCAAe,CAAC,yCAAM,EAAE,cAAM,IAAI,8BAAM;AAC/C,IAAM,gCAAa;EACrB","file":"logger_service.template.ddc.js"}');
  // Exports:
  return {
